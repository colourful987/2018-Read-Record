...
class Translator(NodeVisitor):
    ...
    def visit_ProcedureDecl(self,node):
        ...
        for param in node.params:
            ...
            c_param_type = C_MAP_KEYWORDS[param.type_node.value]
            param_name = param.var_node.value
            var_symbol = VarSymbol(param_name, param_type)
            self.current_scope.insert(var_symbol)
            proc_symbol.params.append(var_symbol)
            one_param = '{param_type} {param_name}'.format(param_type = c_param_type,param_name=param_name)
            params_string += one_param

        self.cCode += params_string + ') {\n'
    ...
    def visit_Num(self,node):
        self.cCode += '{value}'.format(value = node.value)
        return node.value
...
def main():
    ...
    try:
        ...
        print(translator.cCode)
        # print(translator.GLOBAL_SCOPE)
