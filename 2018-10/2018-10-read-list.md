...
纯码代码（python实现），只记录遇到的坑和疑惑点以及现有能想到的解决思路，仅供参考。
...
# 2018/10/31
完善pascal的语法解释器，迎接11月份的计划，以解释器为主题，不能再分心搞别的去了，每次都是浅尝辄止，时间成本和收益太低，俗话说一鼓作气，再而衰，三而竭。因此坚定目标，心无旁骛，方能最终在某一方面有收获，目前解释器相关计划如下（包括已经完成的）：
